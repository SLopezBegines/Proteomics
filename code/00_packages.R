...
# Usage example
libraries <- c("tidyverse","writexl","BiocManager","ggrepel","knitr",
...
libraries_bioconductor <- c("biomaRt","org.Dr.eg.db","org.Mm.eg.db","org.Hs.eg.db","clusterProfiler","enrichplot", "tidySummarizedExperiment", 
...
rm("install_and_load_library_bioconductor","install_and_load_library" )
